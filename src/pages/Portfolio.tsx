          ...
          <Card className="border-navy-700 bg-card-gradient lg:col-span-2">
            ...
            <CardContent className="h-80 flex items-center justify-center">
              <div className="text-center text-gray-400">
                [Portfolio allocation chart would be displayed here]
              </div>
            </CardContent>
            <CardFooter className="border-t border-navy-700 pt-4 flex justify-between flex-wrap">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xl font-semibold text-green-400">+$87.32 (+1.6%)</p>
              </div>
              <div className="space-y-1">
                <p className="text-sm text-gray-400">7d Change</p>
                <p className="text-xl font-semibold text-green-400">+$326.41 (+6.3%)</p>
              </div>
            </CardFooter>
          </Card>
            ...
            <CardContent>
              <Tabs defaultValue="overview">
                ...
                <TabsContent value="overview" className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <Card className="border-navy-700">
                      <CardContent className="p-4">
                        ...
                        <div className="text-2xl font-semibold">${selectedHolding.price.toFixed(2)}</div>
                    ...
                    <Card className="border-navy-700">
                      <CardContent className="p-4">
                        ...
                        <div className="text-sm text-gray-400">
                          ${selectedHolding.value.toFixed(2)} ({selectedHolding.allocation}% of portfolio)
                        </div>
                      </CardContent>
                    </Card>
                    <Card className="border-navy-700">
                  ...
                  <div className="h-64 border border-navy-700 rounded-md p-4 flex items-center justify-center">
                    <div className="text-center text-gray-400">
                      [Price chart for {selectedHolding.symbol} would be displayed here]
                    </div>
                  </div>
