          ...
          <Card className="border-navy-700 bg-card-gradient">
            ...
            <CardContent>
              <div className="text-sm text-gray-400">
                vs. previous period: <span className="text-green-400">+$241.22</span>
              </div>
            </CardContent>
          </Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {[
                      ...
                      { name: "Value at Risk (95%)", value: "-$432.18", description: "Potential daily loss" },
                    ].map((metric, index) => (
                ...
                <CardContent>
                  <div className="space-y-4">
                    {[
                      ...
                      { name: "Average Win", value: "$42.76", description: "Average profit per winning trade" },
                      { name: "Average Loss", value: "-$21.33", description: "Average loss per losing trade" },
                      { name: "Win/Loss Ratio", value: "2.0", description: "Avg win / avg loss" },
                      { name: "Expectancy", value: "$28.37", description: "Expected profit per trade" },
                    ].map((metric, index) => (
                      <div key={index} className="flex justify-between">
                        <div>
                          <div className="font-medium">{metric.name}</div>
          ...
          <TabsContent value="trades" className="pt-6">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <Card className="border-navy-700 bg-card-gradient lg:col-span-3">
                ...
                <CardContent className="h-80 flex items-center justify-center">
                  <div className="text-center text-gray-400">
                    [Trade distribution charts would be displayed here]
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border-navy-700 bg-card-gradient">
                ...
                <CardContent className="h-60 flex items-center justify-center">
                  <div className="text-center text-gray-400">
                    [Trade timing chart would be displayed here]
                  </div>
                </CardContent>
          ...
          <TabsContent value="tokens" className="pt-6">
              ...
              <CardContent>
                <div className="overflow-x-auto">
                  <table className="w-full">
                    ...
                    <tbody>
                      {[
                        { token: "XD-GOLD", trades: 42, winRate: 81, profitLoss: 587.24, avgReturn: 3.2, bestTrade: 92.37, worstTrade: -41.25 },
                        { token: "XD-REALTY", trades: 37, winRate: 73, profitLoss: 324.63, avgReturn: 2.7, bestTrade: 78.52, worstTrade: -36.82 },
                        { token: "XD-CARBON", trades: 28, winRate: 82, profitLoss: 412.88, avgReturn: 4.5, bestTrade: 105.63, worstTrade: -28.75 },
                        { token: "XD-ART", trades: 18, winRate: 61, profitLoss: -42.38, avgReturn: -0.8, bestTrade: 67.24, worstTrade: -56.32 },
                        { token: "XDC", trades: 17, winRate: 65, profitLoss: 102.42, avgReturn: 1.9, bestTrade: 45.28, worstTrade: -32.17 },
                      ].map((item, index) => (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <Card className="border-navy-700 bg-card-gradient">
                ...
                <CardContent className="h-80 flex items-center justify-center">
                  <div className="text-center text-gray-400">
                    [Correlation matrix or heatmap would be displayed here]
                  </div>
                </CardContent>
              </Card>
        ...
        <Card className="border-navy-700 bg-card-gradient">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="bg-navy-800 border-l-4 border-yellow-500 p-4 rounded">
              ...
              <p className="text-sm text-gray-400">
                Your best performing trades occur between 14:00-16:00 UTC. 
